<?php
/**
 * Ferraz_lab05 functions and definitions
 *
...
if ( ! function_exists( 'ferraz_lab05_setup' ) ) :
	/**
	 ...
	 */
	function ferraz_lab05_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Ferraz_lab05, use a find and replace
		 * to change 'ferraz_lab05' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'ferraz_lab05', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'ferraz_lab05_custom_background_args', array(
...
add_action( 'after_setup_theme', 'ferraz_lab05_setup' );
 ...
 */
function ferraz_lab05_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'ferraz_lab05_content_width', 640 );
}
add_action( 'after_setup_theme', 'ferraz_lab05_content_width', 0 );
 ...
 */
function ferraz_lab05_widgets_init() {
...
add_action( 'widgets_init', 'ferraz_lab05_widgets_init' );
